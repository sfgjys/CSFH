...
public class SettingItem extends RelativeLayout {
	...
	public SettingItem(Context context, AttributeSet attrs) {
		super(context, attrs);
		view = View.inflate(ViewsUitls.getContext(), R.layout.settings_item,
				this);
		...
		mMiaoshu = attributes
				.getString(R.styleable.SettingItem_setting_itm_miaoshu);

		mTubiao = attributes.getResourceId(
				R.styleable.SettingItem_setting_itm_tubiao, 0);
	...
	private void initView() {
		...
		TextView mDescribe = (TextView) view
				.findViewById(R.id.tv_setting_miaoshu);
		mDescribe.setText(mMiaoshu);

		ImageView mToRight = (ImageView) view
				.findViewById(R.id.iv_setting_ico_right);
	...
	public void setcSwitchAction(boolean isonoff) {
		setSwitchImage(!isonoff);
	}
