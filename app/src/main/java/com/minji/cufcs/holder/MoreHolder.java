...
import com.minji.cufcs.R.id;
import com.minji.cufcs.R.layout;
...
public class MoreHolder extends BaseHolder<Integer> {
	...
	public View initView() {
		View view = ViewsUitls.inflate(layout.layout_load_more);
		hasMore = (LinearLayout) view.findViewById(id.has_more);
		moreError = (TextView) view.findViewById(id.more_error);
		return view;
	}
