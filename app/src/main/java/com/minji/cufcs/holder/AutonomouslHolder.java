...
public class AutonomouslHolder extends BaseHolder<AutonomouslSingle> {
	...
	@Override
	public void setRelfshData(AutonomouslSingle mData, int postion) {
		...
		mHubName.setText("枢纽名称: " + mData.getSid());
